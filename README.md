...
Since it uses GUI's all the inputs are made through mouse.
...
**Archive File**   |[](https://github.com/Planet-Source-Code/wasim-haque-a5-calculator__3-5807/archive/master.zip)
